...
| Frobenius preserves per-stage tap sparsity | Formal proof | Candidate theorem |
| Exact geometry-sensitive work bound | Formal proof with operation model | Candidate theorem |
